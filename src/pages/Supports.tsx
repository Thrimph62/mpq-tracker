...
function catColor(cat: string | null): string {
  if (!cat) return 'bg-[#52527A] text-[#8888AA] border-[#555]'
  ...
  return 'bg-[#52527A] text-[#8888AA] border-[#555]'
}
      ...
      {loading ? <Spinner /> : (
        <div className="card overflow-x-auto">
          <table className="w-full text-xs">
            ...
            <tbody>
              {visible.map(s => (
                <tr key={s.id} className="border-b border-[#52527A]/40 hover:bg-[#52527A]/20 align-top">
                    ...
                    {s.restriction && s.restriction !== '/' ? (
                      <span className={`badge border text-xs ${
                        ...
                        s.restriction === 'Vilains' ? 'bg-red-900/40  text-red-300  border-red-700'  :
                                                      'bg-[#52527A]   text-[#8888AA] border-[#555]'
                      }`}>{s.restriction}</span>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {EFFECTS.map(n => (
                    <div key={n} className="bg-[#2A2A45] rounded-lg p-3 space-y-2">
              ...
              <div>
                ...
                <div className="bg-[#2A2A45] rounded-lg p-3 space-y-2">
                  <div>
